# Skirmish 07 — release candidate work
...
- A dedicated full-page title menu with Play, Continue, Options and How to Play. Match setup opens behind Play; the battlefield and its rendering remain inactive until a match begins. Pause/results return to the title screen.
