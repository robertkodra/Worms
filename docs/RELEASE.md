# Skirmish 03 — release candidate work
...
- Four worms per team, corrected rotation after elimination, eight supported spawn corridors, and rising water after round 16. Shared finite stock includes two medkits, six shotgun shots and four rifle shots.
- Twelve distinct weapons and tools, a category/search arsenal and four quick slots. The menu is data driven and supports a larger catalog without adding more permanent buttons.
- Four reproducible terrain layouts, each available as Moonlit Garden, Copper Canyon or Frost Hollow. Themes change scenery and material colors; collision rules stay identical.
...
- A separate practice range with unlimited items, no aiming time limit and resetting targets. Physics and weapon behavior match skirmish rules. Practice does not overwrite the skirmish checkpoint.
...
The current suite has 68 tests. The [0.3.1 physics update](PHYSICS.md) records the crater-contact, grenade-response and impact-presentation fixes and their additional validation. Added coverage includes 4v4 spawns and survivor rotation; sudden-death progression through a complete ending; practice isolation; saved-state and future-RNG equivalence; malformed/oversized saves; in-flight rocket, cluster, TNT and airstrike restoration; worker cancellation/fallback; and invalid key bindings.
